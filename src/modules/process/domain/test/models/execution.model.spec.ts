...
describe('ExecutionModel model', () => {
    it('Should create a new execution Model & execute it', () => {
        ...
        return execution.execute().then(data => expect(data).toBeTruthy());

    });


    it('Should create a new execution Model & execute it & stop it', () => {
        const execution = new ProcessModel();
    ...
    it('Should create a new execution Model with sequence & execute it & stop it', () => {
        const execution = new ProcessModel();
